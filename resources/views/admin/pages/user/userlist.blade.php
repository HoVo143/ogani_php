                  ...
                  <tbody>
                    @forelse ( $user as $key=>$users)
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('admin.user.detail', [$users->id])}}" class="btn btn-primary">Detail</a>
                          <a onclick="return confirm('xoa ko ?');" href="{{ route('admin.user.delete', [$users->id])}}" class="btn btn-danger">Delete</a>
